...
<%@include file="../include/header.jsp"%>
	...
	<div class="home">
		...
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background"><img src=/resources/images/banner/home_slider_1.jpg></div>
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background"><img src=/resources/images/banner/home_slider_2.jpg></div>
					<div class="home_slider_content">
						<div class="home_slider_content_inner">
							<div class="home_slider_subtitle">Promo Prices</div>
							<div class="home_slider_title">New Collection</div>
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background"><img src=/resources/images/banner/home_slider_3.jpg></div>
					<div class="home_slider_content">
						<div class="home_slider_content_inner">
							<div class="home_slider_subtitle">Promo Prices</div>
							<div class="home_slider_title">New Collection</div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<div class="section_subtitle">The Best</div>
	...
	<div class="arrivals">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<div class="section_subtitle">The New</div>
			...
			<div class="row products_container">
					...
					<div class="product">
						...
						<div class="product_content clearfix">
							<div class="product_info">
								<div class="product_name"><a href="/Product/product">Woman's Long Dress</a></div>
				...
				<div class="col-lg-4 product_col">
					<div class="product">
						...
						<div class="product_content clearfix">
							<div class="product_info">
								<div class="product_name"><a href="/Product/product">2 Piece Swimsuit</a></div>
				...
				<div class="col-lg-4 product_col">
					<div class="product">
						...
						<div class="product_content clearfix">
							<div class="product_info">
								<div class="product_name"><a href="/Product/product">Man Blue Jacket</a></div>
	...
	<div class="newsletter">
		<div class="newsletter_content">
			<div class="newsletter_image" style="background-image:url(/resources/images/newsletter.jpg)"></div>
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="section_title_container text-center">
				...
				<div class="col text-center">
					...
					<nav class="footer_nav">
						<ul>
							...
							<li><a href="/Product/categories">clothes</a></li>
							<li><a href="/Product/categories">accessories</a></li>
							<li><a href="/Product/categories">lingerie</a></li>
